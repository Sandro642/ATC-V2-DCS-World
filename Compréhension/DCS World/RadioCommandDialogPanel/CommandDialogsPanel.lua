...
function release(self)
	--print('CommandDialogsPanel.release()')
	self:clear()
	--UI
...
function toNextMenuItem(self)
	self.curDialogIt.element_:toNextMenuItem()
end

function toPrevMenuItem(self)
	self.curDialogIt.element_:toPrevMenuItem()
end

function selectCurrentMenuItem(self)
	self.curDialogIt.element_:selectCurrentMenuItem()
end

function toPrevMenu(self)
	self.curDialogIt.element_:toPrevMenu()
end
